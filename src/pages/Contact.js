    ...
    <>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-0 my-[7%]">
          ...
          <div className="py-2">
            ...
            <div className="flex flex-col space-y-10">
              ...
              <div className="flex space-x-7">
                ...
                <div>
                  <h4 className="text-lg font-bold font-serif mb-2">Call Us</h4>
        ...
        <div className="border-l border-black px-[14%]">
          <div className="py-2">
            <h2 className="text-3xl font-serif mb-10">Drop us a line or two</h2>
            ...
            <button className="flex px-7 py-2.5 bg-pink-500 text-white mt-5">Submit</button>
          </div>
        </div>
      </section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 md:gap-20 gap-6 px-10 md:px-20 lg:px-32 mb-20">
